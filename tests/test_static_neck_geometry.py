...
def test_family_hits_V2_and_L_targets_tightly_while_varying_x_neck():
    ...
    # geometry. Very wide necks (roughly frac > 1.15 here) can make (V2, L,
    # x_neck) jointly infeasible for the flat-collar/circular-cap
    # construction -- see static_neck_geometry.py's module docstring and
    ...
    for target_frac, ach in zip((0.7, 0.85, 1.0, 1.15), achieved_x):
